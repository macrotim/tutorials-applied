"""RequestLogger adapted from
https://raw.githubusercontent.com/madeinnordeste/python-mysql-dump-to-amazon-s3/master/boto/requestlog.py

Note that Queue doesn't respond to ctrl-c and the script must be terminated forcefully.
"""
